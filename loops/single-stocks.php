  ...
  <article role="article" id="post_<?php the_ID()?>" <?php post_class()?>>
    ...
    <div class="wrapperGradient"></div>
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h2 class="singleDescStocks">АКЦИЯ</h2>
    ...
    <footer class="container">
      ...
      <div class="row mt-5 border-top pt-3 pb-5">
        <div class="col">
          <?php previous_post_link('%link', '<i class="fas fa-fw fa-angle-left"></i>Предыдущая акция: '.'%title'); ?>
        </div>
        <div class="col text-right">
          <?php next_post_link('%link', 'Следующая акция: '.'%title'.'<i class="fas fa-fw fa-angle-right"></i>'); ?>
        </div>
      </div>
    </footer>
  </article>
